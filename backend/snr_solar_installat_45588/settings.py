"""
Django settings for snr_solar_installat_45588 project.
...
ROOT_URLCONF = 'snr_solar_installat_45588.urls'
...
WSGI_APPLICATION = 'snr_solar_installat_45588.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "snr_solar_installat_45588 API",
    "DESCRIPTION": "API documentation for snr_solar_installat_45588 App",
    "VERSION": "v1",
}
